...
import bmp280driver
from attitude_control_tom import attitude_control
...
for i in range(0,1000):
    attitude_control(speed_command,pitch_command,roll_command, yaw_command)
...
print "step 1"
for i in range(0,1000):
    attitude_control(heading_command,roll_command,pitch_command, X_offset, Y_offset, Z_offset, Head_offset, pressure)
