...
CFangleX_filter_length = 5
CFangleY_filter_length = 5
CFangleZ_filter_length = 5
tiltHeading_filter_length = 5
...
#    aileron_pos = int(aileron_mid_pos + roll_p_gain*roll_error)
    ...
    #pwm.set_pwm(0, 0, throttle_servo_max)

    pwm.set_pwm(1, 0, rudder_pos)

    pwm.set_pwm(2, 0, elevator_pos)

    pwm.set_pwm(3, 0, aileron_pos)
